<div class="container">
  <div class="row">
    ...
    <div class="col-md-12">
      <?php
        if ($add_success) {
          echo '<div class="alert alert-success" role="alert">Edit Successfull!</div>';
        } 
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <?= form_open('crud/process_edit_entry'); ?>
            <?= form_hidden('id', $records['id']); ?>
            ...
            <div class="form-group">
              <?php
                ...
                $data = array(
                  ...
                  'id' => 'name',
                  'class' => 'form-control',
                  'value' => ($error_field) ? set_value('name') : $records['name']
                );
            ...
            <div class="form-group">
              <?php
                ...
                $data = array(
                  ...
                  'class' => 'form-control',
                  'type' => 'number',
                  'value' => ($error_field) ? set_value('phone') : $records['phone']
                );
            ...
            <div class="form-group">
              <?php
                ...
                $data = array(
                  ...
                  'class' => 'form-control',
                  'type' => 'email',
                  'value' => ($error_field) ? set_value('email') : $records['email']
                );
